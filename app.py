...
if authentication_status:
    ...
    with help:
        ...
        with col2:
            ...
            Following up on the success of AstroTool v5.3 (which was made available on this website to the public for free), v6.0 has been completed. It offers several improvements over v5.3 and is now the tool of choice for those who have access to it. 
