...
if authentication_status:
    ...
    with chart:
        ...
        fig.add_vline(x=1, x0="2021-04-15", x1="2021-04-15", line_width=2, line_color="black")
        ...
        fig.add_vline(x=1, x0="2021-06-23", x1="2021-06-23", line_width=2, line_color="black")
        ...
        fig.add_vline(x=1, x0="2021-09-29", x1="2021-09-29", line_width=1, line_color="blue")
        fig.add_vline(x=1, x0="2021-10-20", x1="2021-10-20", line_width=1, line_color="blue")
        fig.add_vline(x=1, x0="2021-10-28", x1="2021-10-28", line_width=1, line_color="blue")
        fig.add_vline(x=1, x0="2021-11-10", x1="2021-11-10", line_width=2, line_color="black")
        fig.add_vline(x=1, x0="2021-11-19", x1="2021-11-19", line_width=1, line_color="blue")
        fig.add_vline(x=1, x0="2021-12-01", x1="2021-12-01", line_width=1, line_color="blue")
        fig.add_vline(x=1, x0="2021-12-04", x1="2021-12-04", line_width=1, line_color="blue")
        fig.add_vline(x=1, x0="2021-12-27", x1="2021-12-27", line_width=1, line_color="blue")
        fig.add_vline(x=1, x0="2022-01-07", x1="2022-01-07", line_width=1, line_color="blue")
        fig.add_vline(x=1, x0="2022-01-13", x1="2022-01-13", line_width=1, line_color="blue")
        fig.add_vline(x=1, x0="2022-01-22", x1="2022-01-22", line_width=1, line_color="blue")
        ...
        fig.add_vline(x=1, x0="2022-02-21", x1="2022-02-21", line_width=1, line_color="blue")
        fig.add_vline(x=1, x0="2022-03-02", x1="2022-03-02", line_width=1, line_color="blue")
        fig.add_vline(x=1, x0="2022-03-06", x1="2022-03-06", line_width=1, line_color="blue")
        fig.add_vline(x=1, x0="2022-03-21", x1="2022-03-21", line_width=1, line_color="blue")
        fig.add_vline(x=1, x0="2022-04-06", x1="2022-04-06", line_width=1, line_color="blue")
        fig.add_vline(x=1, x0="2022-04-14", x1="2022-04-14", line_width=1, line_color="blue")
        ...
        fig.add_vline(x=1, x0="2022-08-18", x1="2022-08-18", line_width=1, line_color="blue")
        fig.add_vline(x=1, x0="2022-08-27", x1="2022-08-27", line_width=1, line_color="blue")
        fig.add_vline(x=1, x0="2022-09-03", x1="2022-09-03", line_width=1, line_color="blue")
        fig.add_vline(x=1, x0="2022-09-18", x1="2022-09-18", line_width=1, line_color="blue")
        fig.add_vline(x=1, x0="2022-09-28", x1="2022-09-28", line_width=2, line_color="blue")
        fig.add_vline(x=1, x0="2022-10-07", x1="2022-10-07", line_width=1, line_color="blue")
